...
import com.example.bandtest.adapter.LeDeviceListAdapter;
import com.example.bandtest.bean.DeviceBean;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                SPUtils.putString(context,SPUtils.DEVICE_ADDRESS,device.getAddress());
                SPUtils.putString(context,SPUtils.DEVICE_NAME,device.getName());
